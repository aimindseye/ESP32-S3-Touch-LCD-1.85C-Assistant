...
![Weather main screen](screenshots/weather-main.jpg)
...
![Weather detail screen](screenshots/weather.jpg)
...
![Music player screen](screenshots/musicplayer.jpg)
...
![Internet Radio screen](screenshots/internetradio.jpg)
...
![Assistant screen](screenshots/aiassistant.jpg)
...
![Settings overview](screenshots/settings.jpg)
...
![Network settings](screenshots/network.jpg)
...
![Time settings](screenshots/time.jpg)
...
![Display settings](screenshots/display.jpg)
...
![Sound settings](screenshots/sound.jpg)
...
![Storage settings](screenshots/storage.jpg)
...
![Device settings](screenshots/device.jpg)
...
![Diagnostics settings](screenshots/diagnostics.jpg)
