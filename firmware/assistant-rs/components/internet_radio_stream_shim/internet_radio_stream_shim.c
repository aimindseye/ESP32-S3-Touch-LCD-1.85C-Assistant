...
#define RADIO_R20_LOW_WATER_BYTES 24576
#define RADIO_R20_PREFILL_TARGET_BYTES 65536
#define RADIO_R20_MAX_REFILL_SPINS 8
...
int32_t st77916_radio_http_mp3_play(const char *url, const char *station_name, uint32_t volume_percent) {
    printf("radio-r36-r24: stream_pacing=BALANCED_R20_RESTORE low_water=%d max_refill_spins=%d refill_chunk=%d input_bytes=%d refill_logs=SUPPRESSED audio=PCM5101_I2S\n",
